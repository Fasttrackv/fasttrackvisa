					...
					<div className="Home-page">
						...
						<div className="banner-area">
							...
							<div className="video_banner_sec video_banner_sec2">
								...
								<iframe className="bannervideo" src="https://player.vimeo.com/video/446724822?h=6e8e42556b&amp;autoplay=1&loop=1&autopause=0&muted=1" allow="autoplay; fullscreen; picture-in-picture" allowFullScreen></iframe>
						...
						<Container>
							...
							<div className="desi-work-container" id="plans">
								<Row className="gutters5">
									{this.props.homepage.homelist.map((homelist, i) =>
										<Col sm={6} md={4} key={i}>
												...
												<Link href={'/' + this.props.country_ext + '/' + homelist.urllink}>
													<a>
														<figure className="visa-img"><LazyLoadImage
															src={'https://cms.fasttrackvisa.com/' + homelist.imageurl} alt={homelist.title} />
							...
							<div className="testimonials-sec">
								<Container>
									...
									<Slider {...Testimonials_sl}>
										...
										{this.props.homepage.testimonial.map((testimonial, i) =>
								...
								<div className='visalistingpage'>
									...
									<div className="banner-area">
										...
										<div className="video_banner_sec video_banner_sec2">
											{this.props.visalisting.allproduct.length != 0 ?
												<>
													{this.props.visalisting.allproduct.map((allproduct, i) =>
														<>
															{i === 0 ?
										...
										<h1 className='pagevtitle'>{this.props.country_ext.replace(/-/g, ' ')}</h1>
									</div>
													...
													<Col sm={6} md={6} lg={4} key={i}>
														...
														<div className="plan_box mb-2">
															...
															<ul className="product-plan">
																...
																<li><Link href={'/checkout/' + allproduct.urllink + '/' + allproduct.id}>
																	<a className="buy_btn">
									...
									<div className='bg-light pt-5 pb-5'>
										...
										<Container>
											...
											<Row>
												{this.props.visalisting.faq_arr.map((faq_arr, i) =>
									...
									<Container className='mb-5'>
										...
										<Slider {...Testimonials_sl}>
											{this.props.visalisting.resarray_near.map((resarray_near, i) =>
												<div className="pro-div">
