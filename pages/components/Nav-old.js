...
const Nav = (props) => {
  ...
  const handleClose2 = () => setRshow(false);
  const handleShow = () => setShow(true);
  const handleShow2 = () => setRshow(true);
    ...
    <>
        ...
        {props.ce_name === '' ?
          ...
          <>
            ...
            {props.meta_url === "404" ?
              ...
              <>
                <title>Something went wrong please try again</title>
                <link rel="canonical" href={'/' + props.ce_name + '/404/'} />
              </>
              :
      ...
      <div className="container dflex position-relative">
          ...
          <ul className="nav navbar">
            ...
            <li className='cdd'>
              ...
              {props.ce_name === "" ?
                ...
                : props.ce_name === "en-sg" ? <span><b className="gss_img flag-sg"></b>SGD <i className='fa fa-angle-down'></i></span>
                  : props.ce_name === "zh-tw" ? <span><b className="gss_img flag-tw"></b>TWD <i className='fa fa-angle-down'></i></span>
                    : props.ce_name === "jp-jp" ? <span><b className="gss_img flag-jp"></b>USD <i className='fa fa-angle-down'></i></span>
              ...
              <div className='cn_dd'>
                ...
                <a href="/jp-jp" className={props.ce_name === "jp-jp" ? "mactive" : ""} title="Japan"><b className="gss_img flag-jp"></b>Japan</a>
        ...
        <ul className="myac_nav">
          <li>
            {userName !== null && userName !== undefined && userName !== '' ? <a onClick={logOut} >Log Out</a> : <a onClick={handleShow}>Sign In</a>}
              ...
              <div className="form">
                ...
                <form>
                  ...
                  <div className="ftv-field">
                    ...
                    <input id="logininput" name="logininput" type="text" className="form-control" ref={userInput} placeholder="Here" />
                  </div>
                ...
                <p className="mt-5 text-center">If you don't have an account, please  <a href="#">Sign Up</a></p>
